...
public class WebSocketClient implements Serializable {
    ...
    /**
     * Connects to web socket server with given server URI. If there is a valid session, it will be closed. This method is one try method. If wants to connect until connection is
     * successful, use reconnect().
     *
    ...
    /**
     * Connects to web socket server with given server URI. If there is a valid session, it will be closed. If conenction is not successful, will try again until connection is
     * successful.
     *
     ...
     *
     * @throws WebSocketException Throws when an exception occurs during disconnection.
     */
