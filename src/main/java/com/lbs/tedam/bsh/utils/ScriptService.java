...
public class ScriptService {
    ...
    public ScriptService(boolean isTest) {
        if (isTest) {
            ...
            TedamLogUtils.log("ScriptService", "configFilePath : " + configFilePath, TedamLogLevel.INFO, true);
            PropUtils.loadPropFile(configFilePath);
        }
        baseRestUrl = PropUtils.getProperty(Constants.BASE_REST_URL);
        TedamLogUtils.log("ScriptService", "ScriptService created ", TedamLogLevel.INFO, true);
    }
