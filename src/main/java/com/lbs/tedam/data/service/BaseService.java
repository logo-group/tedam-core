...
/**
 * This class is an intermediate transition class. This should be the class that will be connected to any DI framework (Spring, CDI etc.)
 *
 * @param <T>
 * @author Tarik.Mikyas
 */
public interface BaseService<T extends AbstractBaseEntity, ID extends Serializable> extends Serializable {
