 ...
 */
public interface TedamScriptAccessorService extends BaseService<TedamScriptAccessor, Integer> {

    /**
     * this method getTedamScriptAccessorListByScriptAndOperationType <br>
     *
