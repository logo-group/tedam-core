...
import com.lbs.tedam.data.repository.NotificationGroupRepository;
...
@Component
public class NotificationGroupDAOImpl extends BaseDAOImpl<NotificationGroup, Integer> implements NotificationGroupDAO {
	...
	private transient NotificationGroupRepository repository;

	@Autowired
	public void setRepository(NotificationGroupRepository repository) {
	...
	public List<NotificationGroup> getNotificationGroupList(Project project) throws LocalizedException {
		try {
			List<NotificationGroup> notificationGroupList = repository.findByProjectAndDeleted(project,
