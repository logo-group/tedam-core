...
public class GridDeleteGenerator extends Generator {
    /**
    ...
    public String generateLookUp() {
        return TestStepType.GRID_DELETE.getBeginRegex() + generate() + TestStepType.GRID_DELETE.getEndRegex();
    }

    @Override
    public void degenerateLookUp(String parameter) {
        String paramWithNoRegex = parameter.replaceAll(TestStepType.GRID_DELETE.getBeginRegex(), "");
