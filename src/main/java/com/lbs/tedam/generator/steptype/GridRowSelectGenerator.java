...
public class GridRowSelectGenerator extends Generator {
    /**
    ...
    public String generateLookUp() {
        return TestStepType.GRID_ROW_SELECT.getBeginRegex() + generate() + TestStepType.GRID_ROW_SELECT.getEndRegex();
    }

    @Override
    public void degenerateLookUp(String parameter) {
        String paramWithNoRegex = parameter.replaceAll(TestStepType.GRID_ROW_SELECT.getBeginRegex(), "");
    ...
    public String generate() {
        ...
        parameter = parameter.replaceAll("\\s+", ""); // remove spaces from int list
        return parameter;
    }
