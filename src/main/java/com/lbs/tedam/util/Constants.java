...
public final class Constants {
	...
	public static final String FILE_SEPARATOR = "/"; // TedamStringUtils.getSystemSeparator(); there is no need for this
														// procedure . with java "/". It was also tested in scripts.
	// Bsh string messages
	...
	// TedamFace is used in the title of the tabs to be used on the testSetView
	// screen.
