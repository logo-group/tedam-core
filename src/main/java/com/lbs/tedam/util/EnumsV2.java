...
public class EnumsV2 {
    ...
    public enum TestStepType implements IEnumsV2 {
        ...
        FORM_FILL("FormFill", "<fof>", "</fof>", "enum.teststeptype.formfill"), //
        BUTTON_CLICK("ButtonClick", "<bc>", "</bc>", "enum.teststeptype.buttonclick"), //
        FILTER_FILL("FilterFill", "<ff>", "</ff>", "enum.teststeptype.filterfill"), //
        VERIFY("Verify", "<fvv>", "</fvv>", "enum.teststeptype.verify"),
    ...
    public enum ModularScriptSahiFilePath {
        ButtonClick("ButtonClick", "ButtonClick" + Constants.FILE_SEPARATOR + "ButtonClick.sah"), //
        FormFill("FormFill", "FormFill" + Constants.FILE_SEPARATOR + "FormFill.sah"), //
        Verify("Verify", "Verify" + Constants.FILE_SEPARATOR + "Verify.sah"), //
        Utils("Utils", "Utils" + Constants.FILE_SEPARATOR + "Utils.sah"),
        Functions("Functions", "Utils" + Constants.FILE_SEPARATOR + "Functions.sah");
