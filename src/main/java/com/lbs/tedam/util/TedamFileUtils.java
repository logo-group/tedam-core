...
public class TedamFileUtils {
    ...
    public static boolean createNewFile(String filePath) throws CreateNewFileException {
        try {
            ...
            if (file.exists()) {
                ...
                LOGGER.error(filePath + " File could not create!");
                return false;
            }
        } catch (IOException e) {
    ...
    public static void createNewFilePath(String filePath) throws CreateNewFileException {
        ...
        try {
            ...
            LOGGER.error(filePath + " File could not create!" + e);
            throw new CreateNewFileException(filePath + " File could not create!");
        }
    }
