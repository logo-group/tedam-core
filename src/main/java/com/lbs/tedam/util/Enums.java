...
public class Enums {
	...
	public enum FileName {
		...
		CONFIG_PROPERTIES("config.properties"), TEDAM_AGENT("TedamAgent"), AGENT_LOG("TedamAgentLog"),
	...
	public enum OperationTypes {
		...
		VERSION(TAG_VERSION), //
		TEST_CASE_ID(TAG_TEST_CASE_ID), TIME_RECORDING(TAG_TIME_RECORDING), CONFIG_FILE_PATH("configFilePath");
	...
	public enum ScriptParameterSahi {
		...
		BUTTON_TYPE("buttonType", 2), VERSION(TAG_VERSION, 3), //
		TEST_CASE_ID(TAG_TEST_CASE_ID, 4), TEST_SET_ID("testSetId", 5), FORM_NAME("formName", 6),
		TIME_RECORDING(TAG_TIME_RECORDING, 7), URL("url", 8), BROWSER("browser", 9), WAIT("wait", 10);
	 ...
	 *         ScriptParameters
	 *         <p>
	 *         Script parameters used in fragmenting the script that comes with
	 *         Command Prop
	 */
	public enum ScriptParameters {
		...
		REPORT_WAIT_SLEEP_MILLIS("reportWaitSleepMillis"), IS_WRITE_FILTERS("isWriteFilters"), //
		...
		TEST_CASE_ID(TAG_TEST_CASE_ID), TEST_STEP_ID("testStepId"), TIME_RECORDING(TAG_TIME_RECORDING),
	...
	public enum Regex {
		...
		EXCHANGE_RATES("!er!"), //
		EQUALS("!equals!"), TEST_STEP("!ts!"), //
		SET_WORK_DATES("!swd!"), COMMA("!cmm!"); //
	...
	/**
	 * When you return an object value for each enum value, you get an enum value
	 * from the Integer value given by a static fromValue() routine.
	 *
	 * @author Tarik.Mikyas
