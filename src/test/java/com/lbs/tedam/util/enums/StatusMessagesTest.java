...
/**
 * StatusMessages The class created for testing the enum.
 *
...
public class StatusMessagesTest {
    ...
    public void test01CreateEnum() {
        StatusMessages statusMessages = StatusMessages.CAUTION;
        statusMessages.getStatus();
        statusMessages.getStatusId();
    }
}
