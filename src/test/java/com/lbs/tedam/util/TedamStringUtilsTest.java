...
public class TedamStringUtilsTest extends BaseServiceTest {
    ...
    public void testFindTestParamaters() throws JobCommandBuildException {
        TestStep testStep = new TestStep("description", "expectedResult", TestStepType.FORM_FILL, "parameter",
    ...
    // @Test
    // public void testFindTestSetTestCaseParameters() {
    // TedamStringUtils.findTestSetTestCaseParameters(new String[] {});
    // }
}
