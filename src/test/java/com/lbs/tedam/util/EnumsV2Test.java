...
public class EnumsV2Test extends BaseServiceTest {
    ...
    @Test
    public void testEnumModularScriptSahiFilePath() {
        ModularScriptSahiFilePath modularScriptSahiFilePath = ModularScriptSahiFilePath.FormFill;
        modularScriptSahiFilePath = ModularScriptSahiFilePath.fromName("Utils");
        modularScriptSahiFilePath.getValue();
        modularScriptSahiFilePath.getPath();
        modularScriptSahiFilePath.toString();
        modularScriptSahiFilePath = ModularScriptSahiFilePath.fromName("test");
        modularScriptSahiFilePath = ModularScriptSahiFilePath.fromName(null);
