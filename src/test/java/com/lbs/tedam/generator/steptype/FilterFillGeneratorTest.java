...
public class FilterFillGeneratorTest extends BaseServiceTest {
    ...
    public void testGenerate() throws LocalizedException {
        FilterFillGenerator filterFillGenerator = (FilterFillGenerator) GeneratorFactory.getGenerator(TestStepType.FILTER_FILL, beanFactory);
        filterFillGenerator.degenerate("12019");
        filterFillGenerator.validate();
        assertNotNull(filterFillGenerator.generate());
    }

    @Test
    public void testGenerateLookUp() throws LocalizedException {
        FilterFillGenerator filterFillGenerator = (FilterFillGenerator) GeneratorFactory.getGenerator(TestStepType.FILTER_FILL, beanFactory);
        filterFillGenerator.degenerateLookUp(TestStepType.FILTER_FILL.getBeginRegex() + "12019");
        assertNotNull(filterFillGenerator.generateLookUp());
    }
