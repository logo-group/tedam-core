...
@SpringBootTest(classes = {JobCommandServiceImpl.class, TestDataConfig.class, DataConfig.class})
public class JobCommandServiceTest extends BaseServiceTest {
    ...
    @Test
    @Transactional
    public void testUpdateJobCommand() throws LocalizedException {
        JobCommand jobCommand = new JobCommand();
        jobCommand = jobCommandService.save(jobCommand);
